...
namespace ros_interface {
    ...
    public:
        ...
        /**
         * @brief 将Vec3f向量数组添加到PointCloud2消息中
         * @param points Vec3f向量数组
         * @param pc2 sensor_msgs::msg::PointCloud2引用，用于存储转换后的点云数据
         */
        ...
        /**
         * @brief 将路径添加到标记数组中
         * @param mkr_ary 标记数组引用
         * @param path 路径点数组
         * @param color 路径颜色
         * @param ns 命名空间
         * @param pt_size 点的大小
         * @param line_size 线的大小
         */
        ...
        /**
         * @brief 将轨迹添加到标记数组中
         * @param mkr_arr 标记数组引用
         * @param traj 轨迹对象
         * @param name_space 命名空间
         * @param color 颜色，默认为草绿色
         * @param size 大小，默认为0.1
         * @param show_waypoint 是否显示航路点，默认为false
         * @param color_in_vel 是否根据速度着色，默认为false
         * @param cmp 颜色映射类型，默认为Jet
         */
         ...
         * @param poly 多面体对象
         * @param ns 命名空间
         * @param use_random_color 是否使用随机颜色
         * @param surf_color 表面颜色
         ...
         * @brief 将边界框添加到标记数组中
         * @param mkrarr 标记数组引用
         * @param box_min 边界框最小点
         * @param box_max 边界框最大点
         * @param ns 命名空间
         * @param color 颜色
         * @param size_x 尺寸x，默认为0.1
         * @param alpha 透明度，默认为1.0
         * @param print_ns 是否打印命名空间，默认为true
         */
         ...
         * @param pt 要添加的点
         * @param color 颜色，默认为草绿色
         * @param ns 命名空间，默认为"undefined_point"
         * @param size 尺寸，默认为0.1
         * @param id ID，默认为0
         */
         ...
         * @param ns 命名空间，默认为"ellipsoid"
         * @param color 颜色，默认为橙色(透明度0.3)
         */
         ...
         * @param p1 第一个点
         * @param p2 第二个点
         * @param color_pt 点的颜色，默认为粉色
         * @param color 线的颜色，默认为橙色
         * @param ns 命名空间，默认为"line"
         * @param pt_size 点的大小，默认为0.1
         * @param line_size 线的大小，默认为0.05
         */
