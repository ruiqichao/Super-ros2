...
bool ROGMap::findNearestInfCellThat(const bool & is, const GridType& target_type,
    ...
    ::fmt::print(::fmt::fg(::fmt::color::yellow), " -- [ROGMap] findNearestInfCellThat failed to find all {} neighbors at start_pos: {}, target_type: {}, is: {}\n",
               cfg_.spherical_neighbor.size(), start_pos.transpose(), static_cast<int>(target_type), is);
    return false;
}
