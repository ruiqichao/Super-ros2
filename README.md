...
1. 将您的**.pcd**文件放置在：
   **[./src/SUPER/mars_uav_sim/perfect_drone_sim/pcd/](./src/SUPER/mars_uav_sim/perfect_drone_sim/pcd)**
2. 修改以下YAML文件中的`pcd_name`参数：
   **[./src/SUPER/mars_uav_sim/perfect_drone_sim/config](./src/SUPER/mars_uav_sim/perfect_drone_sim/config)**
...
- **[./src/SUPER/super_planner/log/cmd_logs](./src/SUPER/super_planner/log/cmd_logs)**
- **[./src/SUPER/super_planner/log/replan_logs](./src/SUPER/super_planner/log/replan_logs)**
...
- **[read_replan_log.cpp](src/SUPER/super_planner/Apps/read_replan_log.cpp)**
- **[traj_opt_tuning.cpp](src/SUPER/super_planner/Apps/traj_opt_tuning.cpp)**
